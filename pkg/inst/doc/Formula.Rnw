...
The reason for this is that this reflects their use as described in \cite{Formula:Chambers+Hastie:1992}
and generalizations would generally require extra effort from the user.}
